...
% end
 ...
 coordz_03(Z(1,1):Z(1+1,1),1:2)=coordinates1(Z(1,1):Z(1+1,1),1:2);
  coordz_05(Z(2,1):Z(2+1,1),1:2)=coordinates1(Z(2,1):Z(2+1,1),1:2);
   coordz_07(Z(3,1):Z(3+1,1),1:2)=coordinates1(Z(3,1):Z(3+1,1),1:2);
